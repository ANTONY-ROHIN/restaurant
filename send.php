...
$emailid = $_POST['emailid'];
  $query = "SELECT * FROM bookings WHERE reserv_date = '$resdate' AND table_no = '$tableno' AND session = '$session';";
	...
	*/
	...
	{
        $sql = "INSERT INTO bookings (`reserv_date`, `table_no`, `session`, `person_name`, `phone_no`, `email_id`) VALUES ('$resdate','$tableno','$session','$pername'+'$pername1','$phoneno','$emailid')";
