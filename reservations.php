...
<div style="position:static; margin-top:35px; margin-left:0px;" class="wrap"><input  name="pername" type="text" placeholder="First Name"></div>
<div style="position:static; margin-top:-58px; margin-left:550px;" class="wrap"><input  name="pername1" type="text" placeholder="Last Name"></div><br>
...
<div class="poss"id="redi" style="margin-top:-110px; margin-left:700px;"><button name="bookButton">Book Table</button></div><br><br>
